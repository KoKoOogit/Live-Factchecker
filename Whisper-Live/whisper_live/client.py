...
class Client:
    ...
    def process_gemini(self, gemini_response):
        """
        Processes and handles the response from the Gemini API

        Args:
            gemini_response (dict): The response recieved from the Gemini API
        
        """

        print("[INFO]: Recieved Gemini response")
    ...
    def on_message(self, ws, message):
        ...
        if "gemini_response" in message.keys():
            self.process_gemini(message["gemini_response"])
